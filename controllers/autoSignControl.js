...
const submitSign = async (req, res) => {
    try {
                ...
                <form style="background-color: #e7e7e7; flex-direction: column; align-items: center; justify-content: center;" action="#" method="post">
                    ...
                    >TRAFFIC SIGN REQUEST</h2>
                        ...
                        <h1 style="margin-top: 5px;
                            font-family: 'Moveo Sans w00 Regular', Arial, Helvetica, sans-serif;"
                            >Your traffic sign submission has been received successfully! We will be with you within 48 hours!</h1>
                        ...
                        font-family: 'Kairos W04 Extended Bold', Arial, Helvetica, sans-serif;
                        line-height: 26px;
                        ">At TBS, we greatly value your commitment to safety and efficiency on our roadways. We wanted to inform you that your Traffic Sign(s) has been successfully submitted. Thank you for taking proactive steps to ensure smooth traffic flow and the safety of all involved.
                        Our team will now review your request thoroughly to ensure the traffic sign meets MUTCD and DOT Regulations. If any further information or revisions are needed, we will promptly reach out to you.
        ...
        const response = {
            message: 'Traffic Sign submitted successfully',
