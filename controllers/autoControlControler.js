              ...
              <body style="margin: 0; padding: 20px; font-family: Arial, sans-serif; background-color: #e7e7e7; color: #000;">
                <div style="max-width: 600px; margin: auto; background: #fff; padding: 20px; border-radius: 8px;">
                  ...
                  <h3>If you need to cancel a date, use the link for that specific day:</h3>
                        <ul>${cancelLinks}</ul>
                    <p style="font-size: 14px;">Our web developer is in the process of trying code a way to switch dates to reschedule jobs. However, if you need to reschedule, click the cancel link and resubmit your job on a different day.
